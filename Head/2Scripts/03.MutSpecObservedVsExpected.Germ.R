...
pdf("../../Body/4Figures/03.MutSpecObservedVsExpected.Germ.R.pdf", width = 22, height = 14)
par(mfrow=c(3,1))
...
# 
barplot(MutSpec12$FreqObs, names = MutSpec12$Subst, col = ColVec, main = paste("Frequencies of Observed Syn substitutions mtDNA (no ND6)"), cex.names = 2, cex.axis = 2)
barplot(MutSpec12$FreqExp, names = MutSpec12$Subst, col = ColVec, main = paste("Frequencies of Expected Syn substitutions mtDNA (no ND6)"), cex.names = 2, cex.axis = 2)
barplot(MutSpec12$ObsToExpFreq, names = MutSpec12$Subst, col = ColVec, main = paste("Obs/Exp Syn substitutions mtDNA (no ND6)"), cex.names = 2, cex.axis = 2)
...
barplot(MutSpec192$FreqObs, names = MutSpec192$names, col = ColVec, main = paste("Frequencies of Observed Syn substitutions mtDNA (no ND6)"), las = 2, cex.names = 1, cex.axis = 1)
barplot(MutSpec192$FreqExp, names = MutSpec192$names, col = ColVec, main = paste("Frequencies of Expected Syn substitutions mtDNA (no ND6)"), las = 2, cex.names = 1, cex.axis = 1)
barplot(MutSpec192$ObsToExpFreq, names = MutSpec192$names, col = ColVec, main = paste("Frequencies of Obs/Frequencies of Exp Syn substitutions mtDNA (no ND6)"), las = 2, cex.names = 1, cex.axis = 1)
